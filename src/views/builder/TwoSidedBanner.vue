<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <piaf-breadcrumb heading="Two-Sided Banner"/>
        <div class="mb-2 mt-2">
        ...
        <b-card class="cf">
          <b-colxx class="col-7 float-left">
            ...
            <b-form @submit.prevent="submitBuilder">
              ...
              <b-form-group label-cols-horizontal label-cols="2" label="VOD">
                <b-input-group>
              ...
              <b-form-group label-cols-horizontal label-cols="2" label="Banner">
                <b-input-group>
      ...
      if (newFile && oldFile && !newFile.active && oldFile.active) {
        ...
        if (newFile.response.success === true) {
          ...
          if (this.response.vod) {
            ...
            this.$notify('primary', '업로드.', '영상을 먼저 업로드하세요.')
          }
  ...
  watch: {
    File_banner: function (val) {
      if (val[0]) {
        ...
        this.$refs.twoSided_banner.active = true
      }
    },
    File_vod: function (val) {
      if (val[0]) {
        this.vModel.vodName = val[0].name
        this.$refs.twoSided_vod.active = true
      }
    }
  },
  computed: {
